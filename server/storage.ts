...
export class MemStorage implements IStorage {
  ...
  async createEvent(insertEvent: InsertEvent): Promise<Event> {
    ...
    const event: Event = {
      ...
      maxTeamSize: insertEvent.maxTeamSize || 4,
      ...
      allowTeamFormation: insertEvent.allowTeamFormation ?? true,
      requireApproval: insertEvent.requireApproval || false,
      emailNotifications: insertEvent.emailNotifications ?? true,
      participantCount: 0,
      submissionCount: 0,
      createdAt: now,
      updatedAt: now
